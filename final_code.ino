...
float moisture_percentage;
 ...
 if(moisture_percentage>=50 && moisture_percentage<=90 )
 {
...
else if(moisture_percentage>=30 && moisture_percentage<50)
 {
...
else if(moisture_percentage>=10 && moisture_percentage<30)
 {
